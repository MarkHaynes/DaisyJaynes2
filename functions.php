...
function add_social_full( $items, $args ) {
    ...
    if ($args->theme_location == 'header-menu') {
        ...
        <ul class="sub-menu">
            ...
            <li id="menu-item-mobile-pinterest" class="menu-item-social"><a href="http://pinterest.com/thedaisyjaynes1"><img src="'. $templateurl .'/images/pinterest.png" width="30" alt="Pinterest">The Daisy Jaynes Pinterest</a></li>
